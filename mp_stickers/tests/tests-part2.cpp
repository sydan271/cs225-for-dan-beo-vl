...
static void checkStickerPlacement(const Image &sticker,
                                  const Image &sheet,
                                  const int &xOffset,
                                  const int &yOffset) {
...
TEST_CASE("StickerSheet does not duplicate stickers in memory",
          "[weight=5][part=2][timeout=30000]") {
   Image alma;
   alma.readFromFile("../data/alma.png");
   Image i;
   i.readFromFile("../data/i.png");
...
TEST_CASE("StickerSheet behaves correctly when a sticker is updated",
          "[weight=5][part=2][timeout=30000]") {
   Image alma;
   alma.readFromFile("../data/alma.png");
   Image i;
...
TEST_CASE("StickerSheet::addSticker() adds a new layer when sheet is full",
          "[weight=5][part=2][timeout=30000]") {
   Image alma;
   alma.readFromFile("../data/alma.png");
   Image i;
...
//
TEST_CASE("StickerSheet::setStickerAtLayer() adds to the correct layer",
          "[weight=5][part=2][timeout=30000]") {
   Image alma;
   alma.readFromFile("../data/alma.png");
   Image i;
...
TEST_CASE("StickerSheet::setStickerAtLayer() past the top layer",
          "[weight=5][part=2][timeout=30000]") {
   Image alma;
   alma.readFromFile("../data/alma.png");
   Image i;
...
TEST_CASE("A complex StickerSheet is correct", "[weight=5][part=2][timeout=30000]") {
   ...
   i.readFromFile("../data/i.png");
   Image expected;
   expected.readFromFile("../data/expected-3.png");
...
TEST_CASE("StickerSheet's copy constructor makes an independent copy",
          "[weight=2][part=2][valgrind][timeout=45000]") {
   Image alma;
   alma.readFromFile("../data/alma.png");
   Image i;
   i.readFromFile("../data/i.png");
   ...
   expected.readFromFile("../data/expected.png");
   Image expected2;
   expected2.readFromFile("../data/expected-2.png");
...
TEST_CASE("A StickerSheet with stickers at negative coordinates works",
          "[weight=5][part=2][timeout=30000]") {
   Image alma;
   alma.readFromFile("../data/alma.png");
   Image i;
...
TEST_CASE("A StickerSheet with stickers placed beyond base image boundaries works",
          "[weight=5][part=2][valgrind][timeout=30000]") {
   Image alma;
   alma.readFromFile("../data/alma.png");
   Image i;
   i.readFromFile("../data/i.png");
