...
size_t insertion_idx_time(std::vector<int> *vec) {
   // check needed since monad calls this with a vector of size 1 (to ``warm up'' the
...
TEST_CASE("test_btree12_double", "[weight=5][timeout=8000]") {
   std::vector<std::pair<float, float>> data = {
       {0.1, 3.4}, {3.5, 4.6}, {2.4, 3.3}, {1.0, 2.0}, {9.0, 8.5},
       {7.6, 1.2}, {8.0, 0.3}, {6.5, 5.5}, {4.6, 9.0}, {1.1, 3.4},
   };
...
TEST_CASE("test_btree12_strings", "[weight=5][timeout=8000]") {
   std::vector<std::pair<std::string, std::string>> data = {
       {"lls", "skye"},     {"mjoras", "yogi"},      {"collin", "meco"}, {"fred", "skye"},
       {"arya", "nymeria"}, {"jon", "ghost"},        {"bran", "summer"}, {"robb", "grey wind"},
