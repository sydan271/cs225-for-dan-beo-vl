...
private:
   ...
   struct DataPair {
       ...
       * otherwise.
       */
      inline bool operator<(const DataPair &rhs) const { return this->key < rhs.key; }
       ...
       */
      inline friend bool operator<(const K &lhs, const DataPair &rhs) { return lhs < rhs.key; }
