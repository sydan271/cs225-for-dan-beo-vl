...
protected:
    ...
    */
   inline bool shouldResize() const { return static_cast<double>(elems) / size >= 0.7; }
...
const size_t HashTable<K, V>::primes[] = {
    17ul,         29ul,         37ul,        53ul,        67ul,        79ul,        97ul,
    131ul,        193ul,        257ul,       389ul,       521ul,       769ul,       1031ul,
    1543ul,       2053ul,       3079ul,      6151ul,      12289ul,     24593ul,     49157ul,
