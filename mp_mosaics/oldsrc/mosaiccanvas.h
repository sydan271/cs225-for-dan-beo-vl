...
inline TileImage &MosaicCanvas::images(int row, int col) { return *myImages[row * columns + col]; }
/**
...
*/
inline uint64_t MosaicCanvas::divide(uint64_t a, uint64_t b) { return (a + b / 2) / b; }
